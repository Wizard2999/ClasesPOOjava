...
public class VistaLetras extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            if (cont < 3) {
                ...
                vectorLetras.setLetras(cont, letra);
                cont++;
                jTextField1.setText("");

            } else {
                JOptionPane.showMessageDialog(null, "Ya no puedes ingresar mas letras");
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "No puedes ingresar números");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaLetras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaLetras().setVisible(true);
            }
        });
    }
